...
/**
 * REST controller for managing {@link com.cheikh.invoice.domain.Correction}.
 */
@RestController
@RequestMapping("/api")
public class CorrectionResource {
    ...
    public ResponseEntity<CorrectionDTO> createCorrection(@RequestBody CorrectionDTO correctionDTO) throws URISyntaxException {
    ...
    public ResponseEntity<CorrectionDTO> updateCorrection(@RequestBody CorrectionDTO correctionDTO) throws URISyntaxException {
