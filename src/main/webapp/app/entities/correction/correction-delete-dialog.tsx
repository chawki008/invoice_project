...
export class CorrectionDeleteDialog extends React.Component<ICorrectionDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.correctionEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="invoiceProjectApp.correction.delete.question">
          <Translate contentKey="invoiceProjectApp.correction.delete.question" interpolate={{ id: correctionEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-correction" color="danger" onClick={this.confirmDelete}>
